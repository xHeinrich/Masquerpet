    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview">
            <a href="#"><i class="fa fa-newspaper-o"></i> <span>Game Users</span> <i class="fa fa-angle-left pull-right"></i></a>
            <ul class="treeview-menu">
              <li><a href="{{ url('admin/game/user') }}"><i class="fa fa-newspaper-o"></i> <span>Users</span></a></li>
              <li><a href="{{ url('admin/game/character') }}"><i class="fa fa-newspaper-o"></i> <span>Characters</span></a></li>
              <li><a href="{{ url('admin/game/item') }}"><i class="fa fa-newspaper-o"></i> <span>Items</span></a></li>
            </ul>
          </li>
          <li class="treeview">
